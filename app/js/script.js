...
window
  ...
  // The code below will check the localstorage if the user over-ridden the device theme setting in the past

  if (localStorage.getItem("theme") === null) {
    
  //  user device theme preference and check and uncheck toggle button
...
const setColorMode = () => {
  ...
  if (localStorage.getItem("theme")) {
    // This is to assure or check there is theme key available in localstorage
